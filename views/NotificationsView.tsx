                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-1 duration-400">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                                    {invitations.map(inv => (
                                        <div key={inv.id} className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all group relative overflow-hidden flex flex-col h-full">
